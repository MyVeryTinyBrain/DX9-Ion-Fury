...
void ObjectStairConcrete::Awake()
{
	//{
	...
	{
		cube->top->SetTexture(0, Resource::FindAs<Texture>(L"../SharedResource/Texture/map/30.png"));
		cube->forward->SetTexture(0, Resource::FindAs<Texture>(L"../SharedResource/Texture/map/30.png"));
		cube->back->SetTexture(0, Resource::FindAs<Texture>(L"../SharedResource/Texture/map/22.png"));
		cube->left->SetTexture(0, Resource::FindAs<Texture>(L"../SharedResource/Texture/map/22.png"));
		cube->right->SetTexture(0, Resource::FindAs<Texture>(L"../SharedResource/Texture/map/22.png"));
		cube->bottom->SetTexture(0, Resource::FindAs<Texture>(L"../SharedResource/Texture/map/22.png"));
	};
